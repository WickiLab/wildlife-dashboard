...
export default function WildTracksDashboard() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-950 text-slate-200 lg:h-screen lg:flex-row lg:overflow-hidden">
        ...
        <main className="custom-scrollbar flex-1 overflow-y-auto p-4 sm:p-6">
          ...
          <div className="flex flex-col gap-6 xl:flex-row">
            ...
            <div className="order-1 min-w-0 flex-1 xl:order-2">
              ...
              <div className="relative h-[58vh] min-h-[20rem] w-full overflow-hidden rounded-2xl border border-slate-800 bg-slate-900 shadow-[0_25px_70px_rgba(0,0,0,0.4)] sm:h-[520px] xl:h-[600px]">
                <div className="pointer-events-none absolute left-2 right-2 top-2 z-[400] flex flex-wrap gap-2 sm:left-4 sm:right-auto sm:top-4">
                  <div className="flex items-center rounded-xl border border-slate-700 bg-slate-950/85 px-2.5 py-1.5 shadow-lg backdrop-blur sm:px-3 sm:py-2">
                    <MapPin className="mr-2 h-4 w-4 text-emerald-400" />
                    <span className="text-xs font-medium text-white sm:text-sm">Esri Satellite Base</span>
                  </div>
