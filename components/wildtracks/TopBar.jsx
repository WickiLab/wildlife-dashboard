...
export default function TopBar({
  ...
  return (
    <header className="sticky top-0 z-10 flex h-16 items-center justify-between border-b border-slate-800 bg-slate-950/70 px-6 backdrop-blur-xl">
      <div className="flex items-center rounded-xl border border-slate-800 bg-slate-900 px-3 py-2">
        ...
        <input
          ...
          className="ml-2 w-64 border-none bg-transparent text-sm text-white placeholder-slate-500 outline-none"
        />
      </div>
      ...
      <div className="flex items-center space-x-6">
        <div className="flex items-center space-x-2">
          ...
          <select
            ...
            className="rounded-xl border border-slate-700 bg-slate-900 px-3 py-2 text-sm text-white outline-none transition focus:border-emerald-500"
          >
